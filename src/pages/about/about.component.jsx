...
import Profile from "../../assets/img/profile/Israt.jpg";
            ...
            <Col xs={12} md={6}>
              <Row className=" align-items-start p-4 my-details rounded">
                ...
                <Col className="d-flex justify-content-center flex-wrap">
                  ...
                  <div>
                    {/* <a href="https://drive.google.com/file/d/1DuEfIcFpl0-u_NWMhHOaQwoHiKP3HBUO/view?usp=sharing" target="_blank" rel="noopener noreferrer">
                      <Button className="m-2" variant="outline-success">
                        My Resume
                      </Button>
                    </a> */}
                    <a href="https://drive.google.com/uc?export=download&id=1aKirBrlU8NHYeso_27KVkPWJjT8hQ3cD" target="_blank" rel="noopener noreferrer">
                      <Button className="m-2" variant="outline-success">
                        My Resume
                      </Button>
                    </a>
                  ...
                  <div>
                    <a href="https://github.com/IsratJahanRuna" target="_blank" rel="noopener noreferrer">
                  ...
                  <div>
                    <a href="https://www.linkedin.com/in/israt-jahan-740b65197/" target="_blank" rel="noopener noreferrer">
